...
var $addRecipe = $("#example-description");
var $contactButton = $("#contactButton");
// var $submitBtn = $("#submit"); we'll potentially change this to a delete button in the "past searches section" 
...
$recipeSearch.on("click", function () {
  ...
  $.ajax({
    ...
    $("#searches-view").text(JSON.stringify(response));

    $("#table-div > tbody").append(response);
  });
});
$addRecipe.on("click");
